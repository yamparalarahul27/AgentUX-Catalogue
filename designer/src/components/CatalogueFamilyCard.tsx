  ...
  return (
    <article className={`catalogue-card catalogue-family-card ${isSelected ? 'catalogue-card--selected is-selected' : ''}`}>
      ...
      <div className="catalogue-card-info">
        ...
        <div className="catalogue-family-card__actions-row">
          <button type="button" className="catalogue-family-card__action" onClick={() => onOpenPreview(family.id)}>
            Preview
          </button>
          <button type="button" className="catalogue-family-card__action" onClick={() => onOpenDetails(family.id)}>
            Edit
          </button>
          <button type="button" className="catalogue-family-card__action" onClick={() => fileRef.current?.click()} disabled={!screenshot}>
            Reupload
          </button>
          <button type="button" className="catalogue-family-card__action is-danger" onClick={() => void requestDelete()}>
            Delete
          </button>
        </div>
      </div>
